...
{    
    ...
    toolbar_python_shell=gtk_tool_button_new(gtk_image_new_from_pixbuf(gdk_pixbuf_new_from_file("./icons/python_shell.png",NULL)),"Open Python Shell");
    toolbar_run=gtk_tool_button_new(gtk_image_new_from_pixbuf(gdk_pixbuf_new_from_file("./icons/run.png",NULL)),"Run");

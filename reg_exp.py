...
#f = open('/media/sda6/C++/gtkmm/csharp/proj.cpp','r')
#f = open('/media/sda6/C/argc.c','r')
#f = open('/media/sda6/C++/gtkmm/csharp/proj.h','r')
#f = open('/media/sda6/C++/csharp/proj.h','r')
...
##downloaded by part3 0 start_size 42807 end_size 57076
